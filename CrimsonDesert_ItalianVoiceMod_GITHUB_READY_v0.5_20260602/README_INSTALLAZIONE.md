...
Prima di installare la `0.5` sopra una `0.3` o `0.3.1`, e' consigliato ripristinare o cancellare gli archivi `0006` gia patchati e poi farli riscaricare/verificare da Steam.

La `0.5` lascia volutamente alcune urla e battute brevi nella voce originale inglese perche risultano piu naturali rispetto alla vecchia generazione AI. Partire da una base pulita evita che in quei punti restino file audio della `0.3`.
